...
namespace BomRepo.ErrorsCatalog
{
    public static class ErrorCatalog
    {
        ...
        public static ErrorDefinition EntityDoesNotExist = new ErrorDefinition("REST.API.105", "Part definition does not exist", ErrorDefinitionClassification.Warning, "Part definition does not exist.", "Part definition was not found in database.", true, "Search for this entity in table Entities on Costumer database.");
